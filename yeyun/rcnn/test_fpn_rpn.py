...
import rcnn
#from rcnn.rcnn_symbol import get_rcnn_symbol
from rcnn.rcnn_symbol_fpn import get_rcnn_symbol
from rcnn.rpn_symbol_fpn import get_rpn_symbol
...
def test_rpn(network, dataset, image_set, root_path, dataset_path,
    ...
    # load symbol
    sym = get_rpn_symbol(network, config.proposal_type, config.num_classes, config.num_anchors, config, is_train=False)
