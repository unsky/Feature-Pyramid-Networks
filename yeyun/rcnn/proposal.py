...
from common.processing.nms import py_nms_wrapper, cpu_nms_wrapper, gpu_nms_wrapper
...
class ProposalProp(mx.operator.CustomOpProp):
    ...
    def list_arguments(self):
        return ['cls_prob', 'bbox_pred', 'im_info','feat_shape']
    ...
    def infer_shape(self, in_shape):
        ...
        feat_shape_shape = in_shape[3]

        if self._output_score:
            return [cls_prob_shape, bbox_pred_shape, im_info_shape,feat_shape_shape], [output_shape, score_shape]
        else:
            return [cls_prob_shape, bbox_pred_shape, im_info_shape,feat_shape_shape], [output_shape]
