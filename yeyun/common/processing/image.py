...
def get_image(roidb, SCALES, PIXEL_MEANS, stride=0):
    """
...
def resize(im, target_size, max_size, stride=0):
    ...
    if stride == 0:
        ...
        #print '#################image_size#############', (im_height, im_width)
