...
def train_net(args, ctx, pretrained, epoch, prefix, begin_epoch, end_epoch, lr, lr_step):
    ...
    feat_sym_p6 = sym.get_internals()['rpn_cls_score/p6_output']
    ...
    rpn_eval_metric_p6 = metric.p6RPNAccMetric()
    rpn_cls_metric_p6 = metric.p6RPNLogLossMetric()
    rpn_bbox_metric_p6 = metric.p6RPNL1LossMetric()
    ...
    for child_metric in [rpn_eval_metric_p3, rpn_cls_metric_p3, rpn_bbox_metric_p3,
                        ...
                        rpn_eval_metric_p6, rpn_cls_metric_p6, rpn_bbox_metric_p6,
